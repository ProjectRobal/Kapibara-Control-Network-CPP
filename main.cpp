...
int main(int argc,char** argv)
{
    ...
    auto second= std::make_shared<snn::LayerSegmented<4,1,10>>(256,gauss1,cross,mutation);
    auto third= std::make_shared<snn::LayerSegmented<256,1,10>>(128,gauss1,cross,mutation);
    auto forth= std::make_shared<snn::LayerSegmented<256,1,10>>(2,gauss1,cross,mutation);
